...
public class ICRogueBehavior extends AreaBehavior {
    ...
    public class ICRogueCell extends Cell {
        ...
        /**
         * Method that causes the two entities (for which the takeCellSpace() method returns true) both live together
         * in the same cell.
        ...
        /**
         * Method that verifies if the cell is interacted.
         * @return boolean
         */
        @Override
        ...
        /**
         * Method that verifies if the actor is interacted.
         * @return boolean
         */
        @Override
