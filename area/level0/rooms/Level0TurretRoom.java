...
public class Level0TurretRoom extends Level0EnemyRoom{
    ...
    private final MoveableTurret turret3 = new MoveableTurret(this, Orientation.UP, new DiscreteCoordinates(4,4), Orientation.values(), 24);
    private final Turret[] enemiesList = {turret1, turret3};
