...
public abstract class Level {
    ...
    /**
     * Method that affects the room to the position x and y of the map.
     * @param coords
     * @param room
     */
    ...
    /**
     * Method that affects a destination to the connector at the position connector.getIndex() in the room to the position
     * x and y of the map.
     * @param coords
     * @param destination
     * @param connector
    ...
    /**
     * Method that does the same as setRoomConnectorDestination but additionally marking the connector as closed.
     * @param coords
     * @param destination
     * @param connector
     */
    ...
    /**
     * to assign a key to the connector at the position connector.getIndex() in the room [coords.x][coords.y] of the map.
     * @param coords
     * @param connector
     * @param keyId
     */
    ...
    /**
     * Method that fills in the map of rooms.
     */
    public abstract void generateFixedMap();

    /**
     * Method that creates rooms randomly.
    ...
    /**
     * Method that allows you to decide the placement of rooms on the map for any level.
     * @param size
     * @return
     */
